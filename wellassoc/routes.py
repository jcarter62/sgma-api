...
async def add_well_assoc(well_id: str, account: str, amount: float, method: str, begindate: str, enddate: str, ordering: int, isactive: int):
...
async def save_well_details(rec_id: str, well_id: str, account: str, amount: float, method: str, begindate: str, enddate: str, ordering: int, isactive: int):
